...
Note that, importantly, $\Pi = (J^\top J)^{\dagger} J^\top J$ is the orthogonal projection onto the row space of $J$;
If the SVD of $J$ is $U\Sigma V^\top$, the SVD of $\Pi$ is $V \text{Diag}(I_r, 0) V^\top$, where $r$ is the rank of $J$.  
