...
%
Clearly, $L(\theta_t)$ converges to a finte value. 

In some settings, we can deduce that $\theta_t$ stays in a bounded set (e.g., via conservation laws). 
